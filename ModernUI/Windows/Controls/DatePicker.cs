...
namespace ModernUI.Windows.Controls
{
    ...
    using ModernUI.Windows.Automation.Peers;
    using ModernUI.Windows.Controls;
    using ModernUI.Windows.Controls.Primitives;
    ...
    public class DatePicker : Control
    {
        ...
        {
            get { return this._calendar.BlackoutDates; }
        }
        ...
        public override void OnApplyTemplate()
        {
            if (this._popUp != null)
            {
                this._popUp.RemoveHandler(PreviewMouseLeftButtonDownEvent, new MouseButtonEventHandler(this.PopUp_PreviewMouseLeftButtonDown));
            ...
            if (this._dropDownButton != null)
            {
                ...
                this._dropDownButton.RemoveHandler(MouseLeaveEvent, new MouseEventHandler(this.DropDownButton_MouseLeave));
            }

            if (this._textBox != null)
            {
                this._textBox.RemoveHandler(TextBox.KeyDownEvent, new KeyEventHandler(this.TextBox_KeyDown));
                this._textBox.RemoveHandler(TextBox.TextChangedEvent, new TextChangedEventHandler(this.TextBox_TextChanged));
                this._textBox.RemoveHandler(TextBox.LostFocusEvent, new RoutedEventHandler(this.TextBox_LostFocus));
            }
            ...
            if (this._popUp != null)
            {
                this._popUp.AddHandler(PreviewMouseLeftButtonDownEvent, new MouseButtonEventHandler(this.PopUp_PreviewMouseLeftButtonDown));
                this._popUp.Opened += this.PopUp_Opened;
                this._popUp.Closed += this.PopUp_Closed;
            ...
            {
                this._dropDownButton.Click += this.DropDownButton_Click;
                this._dropDownButton.AddHandler(MouseLeaveEvent, new MouseEventHandler(this.DropDownButton_MouseLeave), true);
                ...
                {
                    this._dropDownButton.Content = "查看日历";
                }
            }

            this._textBox = this.GetTemplateChild(ElementTextBox) as DatePickerTextBox;
            ...
            if (this._textBox != null)
            {
                this._textBox.AddHandler(TextBox.KeyDownEvent, new KeyEventHandler(this.TextBox_KeyDown), true);
                this._textBox.AddHandler(TextBox.TextChangedEvent, new TextChangedEventHandler(this.TextBox_TextChanged), true);
                this._textBox.AddHandler(TextBox.LostFocusEvent, new RoutedEventHandler(this.TextBox_LostFocus), true);
        ...
        private void InitializeCalendar()
        {
            ...
            this._calendar.SetBinding(Calendar.ForegroundProperty, this.GetDatePickerBinding(DatePicker.ForegroundProperty));            
            this._calendar.SetBinding(Calendar.StyleProperty, this.GetDatePickerBinding(DatePicker.CalendarStyleProperty));
        ...
        private DateTime? ParseText(string text)
        {
            ...
            try
            {
                ...
                {
                    DatePickerDateValidationErrorEventArgs dateValidationError = new DatePickerDateValidationErrorEventArgs(new ArgumentOutOfRangeException("text", "SelectedDate值无效。"), text);
        ...
        private DateTime? SetTextBoxValue(string s)
        {
            ...
            else
            {
                ...
                if (d != null)
                {
                    this.SetValue(TextProperty, this.DateTimeToString((DateTime)d));
                    return d;
                }
                else
                {
        ...
        private void SetWaterMarkText()
        {
            if (this._textBox != null)
            {
                ...
                switch (this.SelectedDateFormat)
                {
                    case DatePickerFormat.Long:
                        {
                            this._textBox.Watermark = string.Format(CultureInfo.CurrentCulture, "选择日期{0}", dtfi.LongDatePattern.ToString());
                            break;
                        }

                    case DatePickerFormat.Short:
                        {
                            this._textBox.Watermark = string.Format(CultureInfo.CurrentCulture, "选择日期{0}", dtfi.ShortDatePattern.ToString());
                            break;
                        }
                }
            }
